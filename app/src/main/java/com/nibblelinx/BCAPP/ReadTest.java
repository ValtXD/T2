...
public class ReadTest extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //setContentView(R.layout.readbc); //Mod

        banco = new TxidDB(ReadTest.this);
        ...
        lista.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, final int position, long id) {
                ...
                String list =  lista.getItemAtPosition(position).toString();
                Intent it = new Intent(ReadTest.this,NFTOPReturn.class);
...
*/
        ...
        if(Flag)
        {
            ...
            Toast.makeText(ReadTest.this, "Connected", Toast.LENGTH_SHORT).show();
        }
        else
        {
            if(netRunFirst) {
            ...
            Toast.makeText(ReadTest.this, "Bad or no Conection", Toast.LENGTH_SHORT).show();
        }
